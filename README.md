...
- `DeepLabv3+`
— **Encoder-Decoder with Atrous Separable Convolution (Liang-Chieh Chen et al., 2018).**  
...
- `SETR`
— **Rethinking Semantic Segmentation from a Sequence-to-Sequence Perspective with Transformers (Sixiao Zheng et al., 2020/2021).**  
